					...
					<div class="row">
						<div class="col-lg-4 ">
							<ul class="breadcrumb">
								...
								<li><a href="#">Forms</a></li> <li class="active">Form Elements</li>
							</ul>
						</div>
						<div class="col-lg-8 ">
...
@section('scripts')
	...
	<script src="{{asset('assets/js/jquery.masked-input.min.js')}}"></script>
	...
	<script src="{{asset('assets/js/jQAllRangeSliders-min.js')}}"></script>
