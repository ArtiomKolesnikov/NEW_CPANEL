				...
				<div class="col-md-10 content-wrapper">
					<div class="row">
						<div class="col-lg-4 ">
							<ul class="breadcrumb">
								...
								<li><a href="#">Forms</a></li> <li class="active">File Upload</li>
							</ul>
						</div>
						<div class="col-lg-8 ">
					...
					<div class="content">
						<div class="main-header">
							<h2>File Upload</h2>
							<em>multiple synchronous file upload with drag and drop support</em>
						</div>

						<div class="main-content">
							<!-- FILE UPLOAD -->
							<div class="widget">
								<div class="widget-header"><h3><i class="fa fa-cloud-upload"></i> File Upload</h3></div>
